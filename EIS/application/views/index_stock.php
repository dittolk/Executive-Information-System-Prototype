                ...
                <div class="row">
                  <div class="col-sm-12">
                    <ul class="nav nav-pills nav-stacked">
                      ...
                      <li class="active"><a href="#StockDahsboard">Stock Dashboard</a></li>
                      <li><a href="index_dirut">Dirut</a></li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="col-sm-9 col-md-9 col-lg-10" id="contemt-main">
              ...
              <div class="row">
                <div class="col-sm-2">
                  <div class="well">
                    <h4 >FG XXX STOCK</h4>
                    <p><span id="produkutama-chart-container">FusionCharts will render here</span></p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="well">
                    <h4>FG XXX STOCK</h4>
                    <p><span id="produkutama2-chart-container">FusionCharts will render here</span></p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="well">
                    <h4 >FG XXX STOCK</h4>
                    <p><span id="produkutama3-chart-container">FusionCharts will render here</span></p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="well">
                    <h4 >FG XXX STOCK</h4>
                    <p><span id="produkutama4-chart-container">FusionCharts will render here</span></p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="well">
                    <h4 >FG XXX STOCK</h4>
                    <p><span id="produkutama5-chart-container">FusionCharts will render here</span></p>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-2">
                  <div class="well">
                    <h4 >MAT XXX STOCK</h4>
                    <p><span id="materialutama-chart-container">FusionCharts will render here</span></p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="well">
                    <h4>MAT XXX STOCK</h4>
                    <p><span id="materialutama2-chart-container">FusionCharts will render here</span></p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="well">
                    <h4>MAT XXX STOCK</h4>
                    <p><span id="materialutama3-chart-container">FusionCharts will render here</span></p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="well">
                    <h4>MAT XXX STOCK</h4>
                    <p><span id="materialutama4-chart-container">FusionCharts will render here</span></p>
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="well">
                    <h4>MAT XXX STOCK</h4>
                    <p><span id="materialutama5-chart-container">FusionCharts will render here</span></p>
                  </div>
                </div>
              </div>
...
<script type="text/javascript" src="<?php echo base_url("assets/js/chart_stock.js"); ?>">
</script>
</html>
